	...
	<tbody>
		<c:forEach var="members" items="${enrolledbatches }">
			<tr>
				...
				<td><a
					href="<%=request.getContextPath()%>/ManagerServlet/approvemember?enrollId=${members.enrollId}&amp;batchSize=${members.batchSize}"
					class="btn btn-success">Approve</a></td>
				<td><a
					href="<%=request.getContextPath()%>/ManagerServlet/rejectmember?enrollId=${members.enrollId}"
